...
export const organizationSchema = {
  ...
  "description": "Profesjonell webutvikling med fokus på resultater og brukeropplevelse. Vi skaper moderne nettsider som både ser fantastiske ut og driver din bedrift fremover.",
  "founder": {
    "@type": "Person",
    "name": "Iver Østensen"
  },
  ...
  "makesOffer": [
    {
      ...
      "itemOffered": {
        "@type": "Service",
        "name": "Webdesign",
        "description": "Moderne, responsivt design som fanger oppmerksomhet og konverterer besøkende til kunder"
      }
    },
    {
      "@type": "Offer",
    ...
    },
    {
      ...
      "itemOffered": {
        "@type": "Service",
        "name": "Support",
        "description": "Kontinuerlig vedlikehold, sikkerhetsopdateringer og teknisk support"
      }
    }
  ]
};
...
export function serviceSchema(serviceName: string, description: string, price?: string) {
  return {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": serviceName,
...
export function reviewSchema(reviewText: string, rating: number, clientName: string, clientCompany?: string) {
  return {
    "@context": "https://schema.org",
    "@type": "Review",
...
export function caseStudySchema(title: string, description: string, url: string, client?: string) {
  return {
    "@context": "https://schema.org",
    "@type": "CreativeWork",
    "name": title,
